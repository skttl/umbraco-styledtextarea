module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        src: [
          'app/scripts/controllers/styled.textarea.controller.js'
        ],
        dest: '<%= dest %>/<%= basePath %>/js/styled.textarea.js',
        nonull: true
      }
    },
    ...
    less: {
      dist: {
        ...
        files: {
          '<%= dest %>/<%= basePath %>/css/styled.textarea.css': 'app/styles/styled.textarea.less',
        }
      }
    },
